    ...
    return (
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
            ...
            <div>
                ...
                <p className='text-[#A8A8A8] text-xl'>Hay! Travelo there to help you find your dream holiday. <br /> Easy you just find where you want to go and buy the ticket.</p>
                    ...
                    <div className='grid grid-cols-2 gap-10 w-fit mx-auto md:mx-0'>
                        {
                            cards.map((card) => (
                                <div key={card.id} className='border-2 border-[#A8A8A8] rounded-3xl w-40 h-40 flex flex-col items-center justify-center space-y-2'>
                                    <h2 className='text-4xl font-semibold text-[#872BFF]'>{card.title}+</h2>
